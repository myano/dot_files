...
beautiful.init("/home/yano/dot_files/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "f", function () awful.util.spawn("/home/yano/firefox/firefox") end),
    awful.key({ modkey, "Shift"   }, "t", function () awful.util.spawn("sudo -u yanotbb -H /home/yanotbb/thunderbird/thunderbird") end),
    awful.key({ modkey, "Shift"   }, "g", function () awful.util.spawn("sudo -u yanotbb -H /usr/bin/google-chrome") end),
